...
par(mfrow=c(2,2))
with(power,plot(Date1,Global_active_power,type="l",xlab="",ylab="Global Active Power"))
with(power,plot(Date1,Voltage,type="l",xlab="datetime",ylab="Voltage"))
...
legend("topright", legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"), lty = c(1,1,1),
       bty = "n")
with(power,plot(Date1,Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power"))
